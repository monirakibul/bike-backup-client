...
import { faFile, faFilePen, faListSquares, faSignOut, faUser, faUserGraduate } from '@fortawesome/free-solid-svg-icons';
...
const Dashboard = () => {
    ...
    return (
        <div>
            ...
            <h2 className="text-2xl  font-bold text-slate-800 bg-white border-b p-5 border-b-gray-200">Dashboard</h2>
                ...
                <div class="drawer-side block">
                    ...
                    <div class="w-60 min-h-full block bg-white absolute" id="sidenavSecExample">
                        ...
                        <ul class="relative px-1">
                            ...
                            <hr />
                            <li class="relative">
                                <div class="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="primary">
