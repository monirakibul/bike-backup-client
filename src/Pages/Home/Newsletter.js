...
const Newsletter = () => {
    return (
        <div className="bg-gray-800 my-10 flex justify-center">
            <div className="py-12 px-4 sm:px-6 lg:py-16 lg:px-8 mx-auto">
                <h2 className="text-2xl text-center leading-9 font-extrabold tracking-tight text-gray-300 sm:text-2xl sm:leading-10">
                    Want  updated News ?
                    <br />
                    <span className="text-primary text-3xl">Sign up for our newsletter.</span>
                </h2>
