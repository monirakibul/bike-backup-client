    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            <div class="flex bg-white border border-gray-200 m-5 rounded-md items-center flex-col p-5">
                <div class="bg-blue-600 text-white rounded-md flex justify-center items-center w-12 h-12 mb-3">
                    <FontAwesomeIcon icon={faTruck} />
                </div>
                <div class="text-center">
                    <h2 class="text-xl font-medium">Free Delivery</h2>
            ...
            <div class="flex bg-white border border-gray-200 m-5 rounded-md items-center flex-col p-5">
                ...
                <div class="text-center">
                    <h2 class="text-xl font-medium">Manufacturers Warranty</h2>
            ...
            <div class="flex bg-white border border-gray-200 m-5 rounded-md items-center flex-col p-5">
                ...
                <div class="text-center">
                    <h2 class="text-xl font-medium">Top-notch support</h2>
            ...
            <div class="flex bg-white border border-gray-200 m-5 rounded-md items-center flex-col p-5">
                ...
                <div class="text-center">
                    <h2 class="text-xl font-medium">Secure payments</h2>
